...
ifstream ind("input_index_7_2.txt");//input index
ifstream coo("input_coordinates_7_2.txt");//input coordinates, dimensionality d is got from here
ofstream outi("output_index_7_2.txt");
ofstream outc("output_coordinates_7_2.txt");
